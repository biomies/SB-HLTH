...
cl = LineClient(authToken='EOxeUt3ab090yp56MpJ4.ieuTkNSNO1nUexlKYncOTa.B1FyvrWks+53DZ/240wFvocfe2Y1uCbpTjVlRNJyuBU=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl,cl.server.CHANNEL_ID['LINE_TIMELINE'])
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EO8n2dk4mxHykI1mNBBc.TESw9XwyDXtonNiO+962Fa.oKXnOXbooSVvvDScPFk11oovJdFUdDWL5nfLbK7zu9I=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EOSPIaHtTq3Da3oqlqg4.UmtT72AAjxAbaJPpAyjUDa.BxaoJ11Q+0ef42w2tZhXW7hBoCNH0ZTgAMdLIBYkyc0=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk,kk.server.CHANNEL_ID['LINE_TIMELINE'])
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EOatNTt31OrsCc0iRLhf.yd07SCrosHZlbkZ5EG7SBW.IoeiF+mZ4CU9sg+hfX+7VEd9KuVMWdDH64VpNAJTmh8=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc,kc.server.CHANNEL_ID['LINE_TIMELINE'])
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='EOOyHr456Nsux0VI47p9.VqnJFpeCW23M8W1v0Ni2wq.qIDI+cEmLI0CiKIlPe7O4W/dBe4f5Gbq4/b0FObPuJY=')
...
def help1():
    ...
    helpMessage1 = "「 HELP-1 」\n\n" + \
                   ...
                   "• " + key + "Tagall\n" + \
                   "• " + key + "Ginfo\n" + \
                   "• " + key + "Infogroup [number]\n" + \
                   "• " + key + "Infogroup[number] [number]\n" + \
                   "• " + key + "Open\n" + \
                   "• " + key + "Close\n" + \
                   "• " + key + "Url\n" + \
                   "• " + key + "Grouplist\n" + \
                   "• " + key + "Grouplist[number] [number]\n" + \
                   "• " + key + "Kibar\n" + \
                   "• " + key + "Absen\n" + \
                   "• " + key + "Respon\n\n" + \
                   "「 SAINT 」\n" + \
                   ...
                   "• " + key + "Botadd @ / Botdell @\n" + \
                   "• " + key + "Admin:repeat [contact]\n" + \
                   "• " + key + "Staff:repeat [contact]\n" + \
                   "• " + key + "Bot:repeat [contact]\n" + \
                   "• " + key + "Listadmin\n" + \
                   "• " + key + "Liststaff\n" + \
                   "• " + key + "Listbot\n\n" + \
                   "「 KEY 」\n" + \
    ...
    try:
                    ...
                    try:
                        if ki.getGroup(op.param1).preventedJoinByTicket == False:
                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                ...
                                X.preventedJoinByTicket = True
                                ki.updateGroup(X)
                                ki.sendMessage(op.param1, None, contentMetadata={'Amid': op.param2}, contentType=13)
                    except:
                        try:
                            if kk.getGroup(op.param1).preventedJoinByTicket == False:
                                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                    ...
                                    X.preventedJoinByTicket = True
                                    kk.updateGroup(X)
                                    kk.sendMessage(op.param1, None, contentMetadata={'Bmid': op.param2}, contentType=13)
                        except:
                            try:
                                if kc.getGroup(op.param1).preventedJoinByTicket == False:
                                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                        ...
                                        X.preventedJoinByTicket = True
                                        kc.updateGroup(X)
                                        kc.sendMessage(op.param1, None, contentMetadata={'Cmid': op.param2}, contentType=13)
                            except:
                                pass
        if op.type == 13:
            if mid in op.param3:
                ...
                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                    try:
                        ...
                        try:
                            ...
                            gMembMids = [contact.mid for contact in group.invitee]
                            for _mid in gMembMids:
                                ki.cancelGroupInvitation(op.param1,[_Amid])
                        except:
                            try:
                                group = kk.getGroup(op.param1)
                                gMembMids = [contact.mid for contact in group.invitee]
                                for _mid in gMembMids:
                                    kk.cancelGroupInvitation(op.param1,[_Bmid])
                            except:
                                try:
                                    group = kc.getGroup(op.param1)
                                    gMembMids = [contact.mid for contact in group.invitee]
                                    for _mid in gMembMids:
                                        kc.cancelGroupInvitation(op.param1,[_Cmid])
                                except:
                                    pass
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "Hi ", "thanks for invite me!")
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                           if msg_dict1[msg_id]["text"] == 'Memuat gambar...':
                                ...
                                ret_ += "\n• Waktu kirim : {}".format(dt_to_str(cTime_to_datetime(msg_dict1[msg_id]["createdTime"])))
                                ...
                                ret_ += "• Pengirim : {}".format(str(ryan.displayName))
                                ret_ += "\n• Nama Grup : {}".format(str(ginfo.name))
                                ret_ += "\n• Waktu Kirim : {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                       ...
                       if msg._from in admin:
                           ...
                           for x in groups.members:
                               if korban in x.displayName:
                                   client.sendText(send, korban + " Sudah Berada Di Grup Ini")
                               else:
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.toType == 2:
               ...
               if msg.contentType == 1:
                    ...
                    msg_dict[msg.id] = {"text":'Gambarnya di bawah',"data":path,"from":msg._from,"createdTime":msg.createdTime}
                  ...
                  if wait["invite"] == True:
                    ...
                    for s in groups.members:
                        if invite in wait["blacklist"]:
                            cl.sendMessage(msg.to, "Ter-blacklist! Hapus blacklist lalu invite lagi")
                            break
                        else:
                            targets.append(invite)
                    if targets == []:
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan anggota bot saint")
                     ...
                     return
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"「 𐀀 HELLTERHEAD 」\nBy : DRE❗\nline.me/ti/p/~mo-banzu")
                                ma = ""
                                for i in creator:
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                ret_ += "\n• Speed : {} Second".format(str(elapsed_time))
...
#CLONE
                          ...
                          if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            try:
                                ...
                                coverId = lineProfile.getProfileDetail()["result"]["objectId"]
...
#KICKALL
                          ...
                          if msg._from in Bots:
                           if msg.toType == 2:
                              ...
                              ki.sendMessage(to,"「 𐀀 HELLTERHEAD WAS HERE! 」\n\n\n"
" █▌▓▒▒░░░░░░░░░░░░░░░░░░░░░░░▒▓█\n"
" █▓▒░░░░░░░░░░░░░░░░░░░░░░░░░▒▓█▌\n"
"█▓▒▒░░░░░░░ 𐀀 HELLTERHEAD ░░░░░░▒▓█\n"
"█▐▒▒░░░░░░░░░░░░░░░░░░░░░░░░░░▒█▓\n"
...
"By : DRE❗\n"
"line.me/ti/p/~mo-banzu")
                              kk.sendMessage(to,"「 𐀀 HELLTERHEAD WAS HERE! 」\n\n\n"
...
"line.me/ti/p/~mo-banzu")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               ki.sendMessage(msg.to, "READY❗".format(str(elapsed_time)))
                               kk.sendMessage(msg.to, "READY❗".format(str(elapsed_time)))
                               kc.sendMessage(msg.to, "READY❗".format(str(elapsed_time)))
                        ...
                        elif 'Protectpro ' in msg.text:
                           if msg._from in admin:
                              spl = msg.text.replace('protectpro ','')
                              if spl == 'on':
                            ...
                            if msg._from in admin:
                                try:cl.inviteIntoGroup(to, ["u20452d2a7b27a3536e1172e4c8d0a8b4"]);has = "OK"
                                except:has = "NOT"
                                try:cl.kickoutFromGroup(to, ["u20452d2a7b27a3536e1172e4c8d0a8b4"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "Healty"
                                else:sil = "Sick"
                                if has1 == "OK":sil1 = "Healty"
                                else:sil1 = "Sick"
                                cl.sendMessage(to, "「 Kesehatan 」\n\n• Kick : {} \n• Invite : {}".format(sil1,sil))
                                try:ki.inviteIntoGroup(to, ["ub5eb16f715987714ce367228ffdeb67c"]);has = "OK"
                                except:has = "NOT"
                                try:ki.kickoutFromGroup(to, ["ub5eb16f715987714ce367228ffdeb67c"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "Healty"
                                else:sil = "Sick"
                                if has1 == "OK":sil1 = "Healty"
                                ...
                                try:kk.inviteIntoGroup(to, ["ub8c4edef669a257681023a4f69826e74"]);has = "OK"
                                except:has = "NOT"
                                try:kk.kickoutFromGroup(to, ["ub8c4edef669a257681023a4f69826e74"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "Healty"
                                else:sil = "Sick"
                                if has1 == "OK":sil1 = "Healty"
                                ...
                                try:kc.inviteIntoGroup(to, ["u603d3bb1c44e4a1ccb04acf97a0eec6f"]);has = "OK"
                                except:has1 = "NOT"
                                try:kc.kickoutFromGroup(to, ["u603d3bb1c44e4a1ccb04acf97a0eec6f"]);has1 = "OK"
                                except:has == "OK"
                                if has == "OK":sil = "Healty"
                                else:sil = "Sick"
                                if has1 == "OK":sil1 = "Healty"
                                ...
                                try:sw.inviteIntoGroup(to, ["ubd03637cf11cc36de6f30d55d2723659"]);has = "OK"
                                except:has = "NOT"
                                try:sw.kickoutFromGroup(to, ["ubd03637cf11cc36de6f30d55d2723659"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "Healty"
                                else:sil = "Sick"
                                if has1 == "OK":sil1 = "Healty"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「 Daftar User Admin 」\n\n"+mb+"\nTotal「%s」Admin" %(str(len(admin))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                for m_id in staff:
                                    ...
                                    mc += str(c) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"「 Daftar User Staff 」\n\n"+mc+"\nTotal「%s」Staff" %(str(len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「 𐀀 HELLTERHEAD  」\n\n• PROTECT URL :\n"+ma+"\n• PROTECT KICK :\n"+mb+"\n• PROTECT CANCEL :\n"+mc+"\n• PROTECT JOIN :\n"+md+"\n• PROTECT INVITE :\n"+me+"\n• Total「%s」Protection" %(str(len(protectqr)+len(protectkick)+len(protectcancel)+len(protectjoin)+len(protectinvite))))
...
#===========BOT UPDATE============#
                          ...
                          if msg._from in admin:
                              cl.sendMessage(msg.to, "「 LINE PLAY 」\n\n Ava Code : HH-7079-6405")

                        elif text.lower() == "codezpt":
                          if msg._from in admin:
                              cl.sendMessage(msg.to, "「 ZEPETO 」\n\n Ava Code : UTEUW4")
                              cl.sendMessage(msg.to, "https://zepeto.me/qr?zepeto://HOME/PROFILE/CARD?UTEUW4")
...
#===========HIBURAN============#
                          ...
                          if msg._from in admin:
                               ...
                               cl.sendMessage(receiver, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)
                                ...
                                if lang not in list_language["list_translate"]:
                                    return cl.sendMessage(to, "Language not found")
                        ...
                        elif cmd.startswith("get-telepon "):
                          if msg._from in admin:
                            sep = msg.text.split(" ")
                          ...
                          if msg._from in admin:
                                ...
                                with requests.session() as web:
                                      ...
                                      if data["result"] != []:
                                          ...
                                          ret += "\n• Like : {}".format(str(data["result"]["likes"]))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              ...
                              midd = korban2[0]
                              jumlah = int(korban2[1])
                              cl.sendText(msg.to,"「 Spam Chat 」\nBerhasil spamchat {} kali".format(str(jumlah)))
                              if jumlah <= 1000:
                                  for var in range(0,jumlah):
...
#=========== [ ADD IMAGE ] ============#
                          ...
                          if msg._from in admin:
                            ...
                            if name in images:
                                ...
                                f = codecs.open("image.json","w","utf-8")
                                json.dump(images, f, sort_keys=True, indent=4, ensure_ascii=False)
                                cl.sendText(msg.to, "Berhasil menghapus image {}".format( str(name.lower())))
                            else:
...
#=========== [ ADD STICKER ] ============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage(msg.to, "「 𐀀 HELLTERHEAD WAS HERE! 」\n\n\n"
" ☣ DANGER❗ ☣ DANGER❗ ☣ DANGER❗ ☣\n"
" ☣ DANGER❗ ☣ DANGER❗ ☣ DANGER❗ ☣\n"
" ☣ DANGER❗ ☣ DANGER❗ ☣ DANGER❗ ☣\n"
" ☣ DANGER❗ ☣ DANGER❗ ☣ DANGER❗ ☣\n"
...
"line.me/ti/p/~mo-banzu")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "READY❗ ".format(str(elapsed_time)))
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                cl.sendText(msg.to, sender, "「 Status Contact 」\n• User ", "\nDeteksi contact dinonaktifkan")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to, sender, "「 Status Jointicket 」\nJoin ticket telah dinonaktifkan")
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Gagal mengganti pesan message")
                              else:
                                  wait["message"] = spl
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Gagal mengganti leave message")
                              else:
                                  wait["leave"] = spl
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Gagal mengganti respon message")
                              else:
                                  wait["Respontag"] = spl
                           ...
                           if msg._from in admin:
                              ...
                              if spl in [""," ","\n",None]:
                                  cl.sendMessage(msg.to, "Gagal mengganti spam message")
                              else:
