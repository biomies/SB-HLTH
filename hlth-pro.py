...
def delete_log():
    ...
    for data in msg_dict:
        if (
            datetime.utcnow() -
            cTime_to_datetime(msg_dict[data]["createdTime"])
        ) > timedelta(1):
...
def changeVideoAndPictureProfile(pict, vids):
    try:
        ...
        raise Exception(
            "Error change video and picture profile {}".format(str(e)))
...
def delete_log1():
    ...
    for data in msg_dict1:
        if (
            datetime.utcnow() -
            cTime_to_datetime(msg_dict1[data]["createdTime"])
...
def atend1():
    ...
    with open("Log_data.json", "w", encoding="utf8") as f:
        json.dump(msg_dict1, f, ensure_ascii=False,
                  indent=4, separators=(",", ": "))
    print("BYE")
                    ...
                    try:
                        ...
                        try:
                            ...
                            try:
                                if (
                                    kc.getGroup(
                                        op.param1).preventedJoinByTicket
                                    == False
                                ):
                                    if (
                                        op.param2 not in Bots
            ...
            if op.param1 in ghost:
                try:
                    if (
                        ...
                        sw.inviteIntoGroup(op.param1, [mid, Amid, Bmid, Cmid])
                        sw.sendMessage(
                            op.param1,
                            None,
                            contentMetadata={"mid": op.param2},
                ...
                try:
                    if (
                        ...
                        Ticket = random.choice(
                            ABC).reissueGroupTicket(op.param1)
                        sw.acceptGroupInvitationByTicket(op.param1, Ticket)
                        sw.kickoutFromGroup(op.param1, [op.param2])
                        sw.inviteIntoGroup(op.param1, [mid, Amid, Bmid, Cmid])
                        sw.sendMessage(
                ...
                if op.param1 in protectantijs:
                    if op.param3 in mid:
                        if (
                            ...
                            kc.findAndAddContactsByMid(op.param1, [Zmid])
                    ...
                    if msg_id in msg_dict1:
                        if msg_dict1[msg_id]["from"]:
                            if msg_dict1[msg_id]["text"] == "Memuat gambar...":
                                ...
                                ret_ = "• Pengirim : {}".format(
                                    str(ryan.displayName))
                                ret_ += "\n• Nama Grup : {}".format(
                                    str(ginfo.name))
                                ret_ += "\n• Waktu kirim : {}".format(
                                    dt_to_str(
                ...
                if msg.toType == 2:
                    if msg._from in admin:
                        if settings["groupPicture"]:
                            ...
                            cl.sendMessage(
                                msg.to, "Berhasil mengubah foto group")
                if msg.contentType == 1:
                    if msg._from in admin:
                        ...
                        # HIBURAN
                            ...
                            if msg._from in admin:
                                ...
                                with requests.session() as web:
                                    ...
                                    result = web.get(
                                        "https://farzain.xyz/api/premium/yt_search.php?apikey=apikey_saintsbot&id={}".format(
                                            str(search)
                                        )
                                    )
                                    data = result.text
                                    ...
                                    if len(cond) == 1:
                                        if data["respons"] != []:
                                            ...
                                            for res in data["respons"]:
                                                num += 1
                                                ret_ += "\n {}. {}".format(
                                                    str(num), str(res["title"])
                                                )
                                            ret_ += "\n\n Total {} Result".format(
                                                str(len(data["respons"]))
                                            )
                                            cl.sendMessage(msg.to, str(ret_))
                                            cl.sendText(
                                                to,
                                                "Ketik yt {} | angka\nuntuk melihat detail lagu".format(
                                                    str(search)
                                                ),
                                            )
                                    if len(cond) == 2:
                                        ...
                                        if num <= len(data["respons"]):
                                            ...
                                            with requests.session() as web:
                                                ...
                                                result = web.get(
                                                    "http://rahandiapi.herokuapp.com/youtubeapi?key=betakey&q=https://www.youtube.com/watch?v={}".format(
                                                        str(res["video_id"])
                                                    )
                                                )
                                                data = result.text
                            ...
                            if msg._from in admin:
                                ...
                                with requests.session() as s:
                                    ...
                                    r = s.get(
                                        "https://www.wowkeren.com/lirik/lagu/{}/{}.html".format(
                                            urllib.parse.quote(artis), judul
                                        )
                                    )
                                    x = s.get(
                                        "https://www.wowkeren.com/seleb/{}/lirik.html".format(
                                            urllib.parse.quote(artis)
                                        )
                                    )
                                    ...
                                    try:
                                        ...
                                        ret_ += (
                                            "\n\n  「 Lirik Lagunya 」"
                                            + data.select("[class~=GambarUtama]")[
                                                1
                                            ].text
                                        )
                                        for link in data1.findAll(
                            ...
                            if msg._from in admin:
                                ...
                                with requests.session() as web:
                                    ...
                                    url = "http://rahandiapi.herokuapp.com/lyricapi?key=betakey&q={}".format(
                            ...
                            if msg._from in admin:
                                ...
                                with requests.session() as s:
                                    ...
                                    try:
                                        ...
                                        cl.sendMessage(
                                            to, "Data cctv tidak ditemukan!")

                        elif cmd.startswith("image: "):
                            if msg._from in admin:
                                sep = msg.text.split(" ")
                                search = msg.text.replace(sep[0] + " ", "")
                                url = "http://rahandiapi.herokuapp.com/imageapi?key=betakey&q={}".format(
                                    urllib.parse.quote(search)
                                )
                                with requests.session() as web:
                                    web.headers["User-Agent"] = random.choice(
                            ...
                            if wait["selfbot"]:
                                if msg._from in admin:
                                    if msg.toType == 2:
                                        group = cl.getGroup(to)
                                        members = [
                                            mem.mid for mem in group.members]
                                        cl.sendMessage(
                                            msg.to,
                        ...
                        # COMMAND ON OFF
                            ...
                            if wait["selfbot"]:
                                if msg._from in admin:
                                    ...
                                    cl.sendMessage(
                                        msg.to, "Spam invite diaktifkan")
                                    cl.sendMessage(
                                        msg.to, "Kirim kontaknya...")
                            ...
                            if not wait["selfbot"]:
                                if msg._from in admin:
                                    settings["SpamInvite"] = False
                                    cl.sendMessage(
                                        msg.to, "Spam invite dinonaktifkan")
